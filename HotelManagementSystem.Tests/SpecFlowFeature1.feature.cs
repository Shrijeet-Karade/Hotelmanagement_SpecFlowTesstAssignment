...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("User  adds a new hotel and then  verifies if hotel is present by providing proper" +
            " inputs")]
        [NUnit.Framework.TestCaseAttribute("4", "hotel4", null)]
        public virtual void UserAddsANewHotelAndThenVerifiesIfHotelIsPresentByProvidingProperInputs(string id, string name, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User  adds a new hotel and then  verifies if hotel is present by providing proper" +
                    " inputs", exampleTags);
#line 18
this.ScenarioSetup(scenarioInfo);
#line 19
...
#line 22
testRunner.When(string.Format("User calls GetHotelById api and passes Id\'{0}\'", id), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 23
testRunner.Then(string.Format("Hotel with name \'{0}\' should be present in the response", name), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("User adds multiple hotels in database and checks for them")]
        [NUnit.Framework.TestCaseAttribute("1", "hotel", "2", "hotel", null)]
        [NUnit.Framework.TestCaseAttribute("3", "hotel", "4", "hotel", null)]
        public virtual void UserAddsMultipleHotelsInDatabaseAndChecksForThem(string id, string name, string id1, string name1, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User adds multiple hotels in database and checks for them", exampleTags);
#line 31
this.ScenarioSetup(scenarioInfo);
#line 32
testRunner.Given(string.Format("User provided valid Id \'{0}\'  and \'{1}\'for hotel", id, name), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
...
#line 39
testRunner.Then(string.Format("Then Hotel with name \'{0}\' and \'{1}\' should be present in the response", name, name1), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
